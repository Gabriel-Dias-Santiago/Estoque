...
public class UsuarioDAO extends DAO {
	...
	public Usuario autenticar(String email, String senha) {
		...
		sql = "select u.nome, u.senha, u.salt, p.nome as perfil from tbl_java_usuario u "
	...
	public void cadastrar(Usuario usuario) {
		...
		try {
			...
			sql = "select id_perfil from tbl_java_perfil where nome = ?";
			ps = connection.prepareStatement(sql);
			...
			sql = "insert into tbl_java_usuario_perfil values(?, ?)";
			ps = connection.prepareStatement(sql);
